 ...
 <div class="container">
    ...
    <div class="infomation">
        ...
        <div class="home-info2">
            ...
            <p v-if="rent.landsize==null">ขนาดที่ดิน : <strong>ไม่มีข้อมูล</strong></p>
            <p v-if="rent.inhomesize!=null"><span>พึ้นที่ใช้สอย : {{rent.inhomesize}}</span></p>
            <p v-if="rent.inhomesize==null">พึ้นที่ใช้สอย : <strong>ไม่มีข้อมูล</strong></p>
        ...
        <div class="row justify-content-center btn-back">
            <button class="btn btn-success" v-on:click="navigateTo('/front-rents')"><i class="fa fa-arrow-left"></i> กลับ</button>
        </div>
    </div>
